    ...
    return ListView(
      ...
      children: [
        _buildActiveBattleCard(
          ...
          postedCount: 2,
          timeLeft: '18h left',
          onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const BattleViewScreen(isActive: true))),
        ),
        _buildActiveBattleCard(
          theme: 'DATE NIGHT',
          ...
          children: [
            Row(
              children: [
                ...
                Text(theme, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
                const Spacer(),
                Text(timeLeft, style: const TextStyle(color: Colors.white70)),
              ],
            ),
            const SizedBox(height: 12),
            Text('${postedCount == participants.length ? 'All posted!' : '$postedCount/${participants.length} posted'}', style: const TextStyle(color: Colors.green)),
